...
this.primevue.autocomplete = (function (utils, Button, Ripple, vue) {
    'use strict';
        ...
        methods: {
            ...
            selectHighlightItem(event, item) {
                if (this.optionGroupLabel) {
                    ...
                    this.selectItem(event, this.suggestions[utils.DomHandler.indexOfType(item)]);
                }
            },
            findNextItem(item) {
...
}(primevue.utils, primevue.button, primevue.ripple, Vue));
