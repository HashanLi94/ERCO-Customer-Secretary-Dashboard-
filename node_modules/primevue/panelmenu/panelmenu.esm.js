import { resolveComponent, openBlock, createBlock, Fragment, renderList, withCtx, createVNode, toDisplayString, createCommentVNode, Transition, withDirectives, vShow } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_sub_panelmenu = resolveComponent("sub-panelmenu");
                ...
                default: withCtx(() => [
                  withDirectives(createVNode("div", _hoisted_4, [
                    ($options.visible(item) && item.items)
                      ? (openBlock(), createBlock(_component_sub_panelmenu, {
                          model: item.items,
                          key: item.label + '_sub_'
                        }, null, 8, ["model"]))
                      : createCommentVNode("", true)
                  ], 512), [
                    [vShow, item === $data.activeItem]
                  ])
                ]),
                _: 2
              }, 1024)
