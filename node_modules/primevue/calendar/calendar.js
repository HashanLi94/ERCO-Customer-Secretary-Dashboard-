...
this.primevue.calendar = (function (utils, InputText, Button, Ripple, vue) {
    'use strict';
    ...
    var script = {
        ...
        methods: {
            ...
            onOverlayEnter() {
                if (this.autoZIndex) {
                    this.overlay.style.zIndex = String(this.baseZIndex + utils.DomHandler.generateZIndex());
                }
...
}(primevue.utils, primevue.inputtext, primevue.button, primevue.ripple, Vue));
