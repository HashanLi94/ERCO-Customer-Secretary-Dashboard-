...
import { resolveComponent, resolveDirective, openBlock, createBlock, mergeProps, createCommentVNode, createVNode, Transition, withCtx, Fragment, renderList, renderSlot, withDirectives, toDisplayString, createTextVNode, withKeys } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("span", {
    ...
    createVNode(Transition, {
      ...
      onEnter: _cache[47] || (_cache[47] = $event => ($options.onOverlayEnter($event))),
