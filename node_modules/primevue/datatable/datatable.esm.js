import { DomHandler, ConnectedOverlayScrollHandler, ObjectUtils } from 'primevue/utils';
import { FilterOperator, FilterService, FilterMatchMode } from 'primevue/api';
import Paginator from 'primevue/paginator';
import { openBlock, createBlock, withKeys, withModifiers, createVNode, resolveComponent, resolveDynamicComponent, createCommentVNode, Transition, withCtx, Fragment, renderList, toDisplayString, resolveDirective, withDirectives, createTextVNode, renderSlot, createSlots } from 'vue';
...
const _hoisted_2$3 = /*#__PURE__*/createVNode("span", { class: "p-row-editor-save-icon pi pi-fw pi-check" }, null, -1);
const _hoisted_3$3 = /*#__PURE__*/createVNode("span", { class: "p-row-editor-cancel-icon pi pi-fw pi-times" }, null, -1);
                    ...
                    return (openBlock(), createBlock(Fragment, {
                      ...
                      ($options.shouldRenderBodyCell($props.value, col, index))
                        ? (openBlock(), createBlock(_component_DTBodyCell, {
                          ...
                          }, null, 8, ["rowData", "column", "index", "selected", "rowTogglerIcon", "frozenRow", "rowspan", "editMode", "editing"]))
                        : createCommentVNode("", true)
                    ], 64))
                  }), 128))
