          ...
          (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($props.columns, (col, i) => {
            return (vue.openBlock(), vue.createBlock("td", {
              ...
              (col.children && col.children.body)
                ...
                : (vue.openBlock(), vue.createBlock("span", _hoisted_2, vue.toDisplayString($options.resolveFieldData($props.node.data, $options.columnProp(col, 'field'))), 1))
            ], 6))
          }), 128))
        ], 38),
...
}(primevue.utils, api, primevue.ripple, Vue, primevue.paginator));
