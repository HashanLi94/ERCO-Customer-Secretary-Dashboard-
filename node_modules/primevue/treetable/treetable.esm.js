...
import { resolveComponent, resolveDirective, openBlock, createBlock, Fragment, createVNode, renderList, withDirectives, createCommentVNode, resolveDynamicComponent, toDisplayString, renderSlot, createSlots, withCtx, createTextVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_sub_ttnode = resolveComponent("sub-ttnode");
  ...
  return (openBlock(), createBlock(Fragment, null, [
      ...
      (openBlock(true), createBlock(Fragment, null, renderList($props.columns, (col, i) => {
        return (openBlock(), createBlock("td", {
          ...
          (col.children && col.children.body)
            ...
            : (openBlock(), createBlock("span", _hoisted_2, toDisplayString($options.resolveFieldData($props.node.data, $options.columnProp(col, 'field'))), 1))
        ], 6))
      }), 128))
    ], 38),
    ($options.expanded && $props.node.children && $props.node.children.length)
      ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList($props.node.children, (childNode) => {
          return (openBlock(), createBlock(_component_sub_ttnode, {
            key: childNode.key,
...
const _hoisted_2$1 = { class: "p-treetable-loading-overlay p-component-overlay" };
const _hoisted_3 = {
  key: 1,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", _hoisted_4, [
      createVNode("table", _hoisted_5, [
        createVNode("thead", _hoisted_6, [
          createVNode("tr", null, [
            (openBlock(true), createBlock(Fragment, null, renderList($options.columns, (col, i) => {
              return (openBlock(), createBlock("th", {
                ...
                ($options.columnProp(col, 'header'))
                  ? (openBlock(), createBlock("span", _hoisted_7, toDisplayString($options.columnProp(col, 'header')), 1))
                  : createCommentVNode("", true),
                ...
                ($options.isMultiSorted(col))
                  ? (openBlock(), createBlock("span", _hoisted_8, toDisplayString($options.getMultiSortMetaIndex(col) + 1), 1))
                  : createCommentVNode("", true)
        ...
        ($options.hasFooter)
          ? (openBlock(), createBlock("tfoot", _hoisted_10, [
              createVNode("tr", null, [
                (openBlock(true), createBlock(Fragment, null, renderList($options.columns, (col, i) => {
                  return (openBlock(), createBlock("td", {
                    key: $options.columnProp(col, 'columnKey')||$options.columnProp(col, 'field')||i,
                    ...
                    (col.children && col.children.footer)
                      ? (openBlock(), createBlock(resolveDynamicComponent(col.children.footer), {
                          key: 0,
                          column: col
                        }, null, 8, ["column"]))
                      : createCommentVNode("", true),
                    createTextVNode(" " + toDisplayString($options.columnProp(col, 'footer')), 1)
                  ], 6))
                }), 128))
              ])
            ]))
          : createCommentVNode("", true),
        createVNode("tbody", _hoisted_11, [
          (!$options.empty)
            ...
            : (openBlock(), createBlock("tr", _hoisted_12, [
                createVNode("td", {
    ...
    (_ctx.$slots.footer)
      ...
      : createCommentVNode("", true),
    createVNode("div", _hoisted_14, null, 512)
  ], 2))
}
